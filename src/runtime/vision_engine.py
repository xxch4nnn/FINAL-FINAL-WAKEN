...
class VisionEngine:
    ...
    def run(self):
        ...
        while self.cap.isOpened():
            ...
            draw_text_with_outline(frame, f"State: {state_name}", (50, 70), font_scale=1, text_color=color)

            # On-screen Keyboard Shortcuts
            draw_text_with_outline(frame, "[ESC] Quit", (50, 30), font_scale=0.6, text_color=(200, 200, 200))
