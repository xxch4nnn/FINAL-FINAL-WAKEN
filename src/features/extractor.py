...
import math  # ⚡ Bolt: Required for faster scalar sqrt
...
class HandFeatureExtractor:
    ...
    def _get_euclidean(self, p1, p2):
        ...
        dx = int(p1[0] - p2[0])
        dy = int(p1[1] - p2[1])
        # ⚡ Bolt: math.sqrt is faster than np.sqrt for scalars
    ...
    def process_live(self, landmarks, distance_cm=115.0):
        ...
        if len(self.history) >= 2:
            ...
            # ⚡ Bolt: Native sum/len is faster than np.mean for small lists
