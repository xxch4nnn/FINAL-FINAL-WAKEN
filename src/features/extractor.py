...
class HandFeatureExtractor:
    ...
    def _to_pixel(self, landmark):
        ...
        # ⚡ Bolt: Return native tuple instead of numpy array for faster creation in hot loop
        return (
    ...
    def _get_euclidean(self, p1, p2):
        ...
        # ⚡ Bolt: Use math.hypot instead of np.sqrt for faster distance calculation
        # p1 and p2 are native tuples
        dx = p1[0] - p2[0]
        dy = p1[1] - p2[1]
    ...
    def process_live(self, landmarks, distance_cm=115.0):
        ...
        if len(self.history) >= 2:
            ...
            # ⚡ Bolt: Use native sum()/len() instead of np.mean() for faster averaging of small lists
