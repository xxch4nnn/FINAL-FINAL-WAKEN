...
class HandFeatureExtractor:
    ...
    def _to_pixel(self, landmark):
        ...
        # Optimization: Return tuple instead of np.array to avoid instantiation overhead
        return (
    ...
    def _get_euclidean(self, p1, p2):
        ...
        # Optimization: Native math.hypot is much faster than np.sqrt for scalars
        return math.hypot(int(p1[0] - p2[0]), int(p1[1] - p2[1]))
