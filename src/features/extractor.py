...
class HandFeatureExtractor:
    ...
    def _get_euclidean(self, p1, p2):
        ...
        dx = int(p1[0] - p2[0])
        dy = int(p1[1] - p2[1])
        # ⚡ Bolt: Using math.hypot instead of np.sqrt for scalar operations provides significant performance improvement by avoiding NumPy's C-API dispatch overhead.
