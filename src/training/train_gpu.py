...
def train():
    ...
    # Export an identity scaler and selected features for pipeline consistency
    # To maintain pipeline consistency for main_runtime.py without altering prediction logic,
    # the training script exports an 'identity' JSON scaler (means of 0.0, scales of 1.0)
    # as the model is trained on unscaled data but the downstream pipeline strictly requires a scaler object.
    scaler_data = {
