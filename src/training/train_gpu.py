...
MODEL_PATH = MODEL_DIR / "rf_model.json" # 🛡️ Sentinel: Naming it json for secure serialization
TARGET_COLS = [
...
def train():
    ...
    # Save
    # 🛡️ Sentinel: Save XGBoost model securely using native JSON serialization
    # to prevent insecure deserialization vulnerabilities associated with joblib/pickle.
