...
MODEL_PATH = MODEL_DIR / "rf_model.json" # Secure JSON serialization
TARGET_COLS = [
...
def train():
    ...
    # Save
    # 🛡️ Sentinel: Fix insecure deserialization vulnerability
    # Do not use joblib/pickle for ML model serialization.
    # XGBoost supports safe, native JSON export.
