...
def main():
    ...
    try:
        while running:
            ...
            # 1. Camera Intrinsics (Est) - Caching
            if K is None:
                h, w = frame.shape[:2]
                ...
                for i, mid in enumerate(ids.flatten()):
                    if mid == 0: # Assuming Marker 0 is the anchor
                        ...
                        if success:
                            ...
                            # ⚡ Bolt: Vectorized projection and batched drawing
                            pts_2d, _ = cv2.projectPoints(keys_3d_points.reshape(-1, 3), rvec, tvec, K, D)
