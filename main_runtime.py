...
class JSONScaler:
    """
    Reconstructs scaler from JSON to avoid joblib insecure deserialization.
    Converts mean_ and scale_ lists to numpy arrays to maintain the 'transform' interface.
    """
