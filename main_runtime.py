...
def main():
    ...
    # 1. Camera Intrinsics (Est) Pre-computation
    ...
    # Pre-compute 3D Key Geometry for vectorized rendering
    keys_3d = []
    ...
    keys_3d = np.array(keys_3d, dtype=np.float32) # Shape: (NUM_KEYS, 4, 3)
