    ...
    try:
        while running:
            ...
            if results.multi_hand_landmarks:
                         ...
                         if offset > 0:
                             ...
                             if 0 <= k_i < CONFIG['NUM_KEYS']:
                                 ...
                                 draw_text_with_outline(vis_frame, f"Key: {k_i}", (int(lm[8].x*w), int(lm[8].y*h)-20),
                                                        font_scale=0.5, text_color=(0,255,255))
                ...
                draw_text_with_outline(vis_frame, f"State: {state_str}", (10, 70), font_scale=1, text_color=color)

                # On-screen Keyboard Shortcuts
                draw_text_with_outline(vis_frame, "[q] Quit  [v] Switch Cam", (10, 30), font_scale=0.6, text_color=(200, 200, 200))
