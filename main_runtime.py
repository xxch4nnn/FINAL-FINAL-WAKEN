...
class JSONScaler:
    """Replicates StandardScaler.transform() interface without insecure deserialization."""
    def __init__(self, json_data):
        self.mean_ = np.array(json_data['mean_'])
        self.scale_ = np.array(json_data['scale_'])
