                ...
                for i, mid in enumerate(ids.flatten()):
                    if mid == 0: # Assuming Marker 0 is the anchor
                        ...
                        if success:
                            ...
                            # ⚡ Bolt: Project all keys in a single OpenCV C++ call and batch render
                            pts_2d, _ = cv2.projectPoints(keys_3d_batch, rvec, tvec, K, D)
