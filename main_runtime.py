...
class JSONScaler:
    """Reconstructs scaler interface from JSON data"""
    def __init__(self, data):
        self.mean_ = np.array(data['mean']) if 'mean' in data else None
        self.scale_ = np.array(data['scale']) if 'scale' in data else None
