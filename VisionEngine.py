    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "Shortcuts: [Q]uit [C]alibrate [SPACE] Next", (10, 30), font_scale=0.7)
                ...
                if self.calibration.active:
                    ...
                    if hand_detected:
                        ...
                        draw_text_with_outline(frame, state, (w-200, 60), font_scale=1, text_color=color, thickness=3)
