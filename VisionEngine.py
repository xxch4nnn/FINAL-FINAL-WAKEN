...
def draw_text_with_outline(img, text, pos, font, font_scale, color, thickness):
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "[q] Quit | [c] Calibrate | [SPACE] Next", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
