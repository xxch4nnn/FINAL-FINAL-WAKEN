...
def draw_text_with_outline(img, text, pos, font, scale, color, thickness=2):
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "Shortcuts: [q]uit [c]alibrate [space]next", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
