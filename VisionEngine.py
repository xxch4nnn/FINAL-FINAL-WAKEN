...
def draw_text_with_outline(img, text, org, fontFace, fontScale, color, thickness=1, lineType=cv2.LINE_AA):
    cv2.putText(img, text, org, fontFace, fontScale, (0, 0, 0), thickness + 2, lineType)
