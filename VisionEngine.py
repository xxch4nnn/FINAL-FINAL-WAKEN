...
def draw_text_with_outline(img, text, position, font, scale, color, thickness=2, outline_color=(0,0,0), outline_thickness=4):
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "'q' - Quit | 'c' - Calibrate | 'SPACE' - Next Step", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
