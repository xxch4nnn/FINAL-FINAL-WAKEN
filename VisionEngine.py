    ...
    def run(self):
        ...
        try:
            while True:
                ...
                # Place slightly higher to avoid clashing with calibration status
                hint_text = "Controls: [c] Calibrate | [SPACE] Next Step | [q] Quit"
                cv2.putText(frame, hint_text, (20, h - 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 4)
                cv2.putText(frame, hint_text, (20, h - 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
