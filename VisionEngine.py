...
def draw_text_with_outline(img, text, pos, font, scale, color, thickness):
    """Draws text with a black outline to ensure WCAG contrast guidelines against dynamic backgrounds."""
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "Shortcuts: Q=Quit, C=Calibrate, SPACE=Next", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
