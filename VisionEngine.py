...
def draw_text_with_outline(img, text, org, fontFace, fontScale, color, thickness, outline_color=(0, 0, 0), outline_thickness=4):
    """Draws text with a thick outline to ensure readability against any background."""
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "[Q] Quit | [C] Calibrate | [SPACE] Next", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
