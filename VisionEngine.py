...
def draw_text_with_outline(img, text, pos, font_scale=1, text_color=(255, 255, 255)):
    """Draws text with a thick black outline for better readability against varied camera feeds."""
    # Draw thick black outline
    cv2.putText(img, text, pos, cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 0, 0), 4)
    # Draw thin white (or custom color) inner text
    cv2.putText(img, text, pos, cv2.FONT_HERSHEY_SIMPLEX, font_scale, text_color, 2)
            ...
            while True:
                ...
                if results.multi_hand_landmarks:
                    ...
                    for hand_landmarks in results.multi_hand_landmarks:
                        ...
                        draw_text_with_outline(frame, f"Rel Depth: {current_rel_depth:.4f}", (10, 120), font_scale=0.6, text_color=(255, 255, 0))
                ...
                if self.calibration.active:
                    ...
                    draw_text_with_outline(frame, status_msg, (20, h-20), font_scale=0.7, text_color=(0, 255, 255))
                else:
                    # Normal Operation
                    draw_text_with_outline(frame, f"Threshold: {self.calibration.threshold_z:.4f}", (10, 150), font_scale=0.6, text_color=(255, 255, 0))
                    ...
                    if hand_detected:
                        ...
                        draw_text_with_outline(frame, state, (w-300, 50), font_scale=1, text_color=color)

                # On-screen Keyboard Shortcuts
                draw_text_with_outline(frame, "[q] Quit  [c] Calibrate  [SPACE] Next", (10, 30), font_scale=0.6, text_color=(200, 200, 200))
