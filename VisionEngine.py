            ...
            while True:
                ...
                if results.multi_hand_landmarks:
                    ...
                    for hand_landmarks in results.multi_hand_landmarks:
                        ...
                        draw_text_with_outline(frame, f"Rel Depth: {current_rel_depth:.4f}", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                ...
                if self.calibration.active:
                    ...
                    # Normal Operation
                    draw_text_with_outline(frame, f"Threshold: {self.calibration.threshold_z:.4f}", (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                ...
                draw_text_with_outline(frame, "[Q] Quit | [C] Calibrate | [SPACE] Next Step", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
