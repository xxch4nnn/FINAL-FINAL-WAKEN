...
def draw_text_with_outline(img, text, position, font, font_scale, color, thickness):
    """Draws text with a black outline for better contrast on dynamic backgrounds."""
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "Shortcuts: 'q' to Quit, 'c' to Calibrate, 'SPACE' for Next Step", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
