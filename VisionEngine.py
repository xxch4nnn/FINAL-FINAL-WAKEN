...
def draw_text_with_outline(img, text, pos, font, scale, text_color, thickness):
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "[q] Quit [c] Calib [Space] Next", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
