    ...
    def run(self):
        ...
        try:
            while True:
                ...
                draw_text_with_outline(frame, "[q] Quit | [c] Calibrate | [SPACE] Next Step", (10, 30), font_scale=0.7, text_color=(255, 255, 255), thickness=2)
                ...
                if self.calibration.active:
                    ...
                    draw_text_with_outline(frame, status_msg, (20, h-20), font_scale=0.7, text_color=(0, 255, 255), thickness=2)
                else:
                    # Normal Operation
                    ...
                    if hand_detected:
                        ...
                        draw_text_with_outline(frame, state, (w-200, 50), font_scale=1.0, text_color=color, thickness=3)
