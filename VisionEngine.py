            ...
            while True:
                ...
                if results.multi_hand_landmarks:
                    ...
                    for hand_landmarks in results.multi_hand_landmarks:
                        ...
                        draw_text_with_outline(frame, f"Rel Depth: {current_rel_depth:.4f}", (10, 140),
                ...
                if self.calibration.active:
                    ...
                    # Normal Operation
                    draw_text_with_outline(frame, f"Threshold: {self.calibration.threshold_z:.4f}", (10, 170),
                               cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
                    ...
                    if hand_detected:
                        ...
                        draw_text_with_outline(frame, "[Q]uit  [C]alibrate  [SPACE] Capture", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
