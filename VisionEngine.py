        ...
        try:
            while True:
                ...
                if self.calibration.active:
                    ...
                    # Keyboard Hints
                    cv2.putText(frame, "[Q] Quit  [C] Calibrate  [SPACE] Next Step", (10, h - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 4)
                    cv2.putText(frame, "[Q] Quit  [C] Calibrate  [SPACE] Next Step", (10, h - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                    ...
                    if hand_detected:
                        ...
                        cv2.putText(frame, state, (w-200, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 5)
