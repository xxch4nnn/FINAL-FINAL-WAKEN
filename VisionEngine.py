        ...
        try:
            while True:
                ...
                if self.calibration.active:
                    ...
                    # Overlay (moved to top below shortcuts to avoid overlapping bottom content)
                    cv2.rectangle(frame, (0, 45), (w, 85), (0, 0, 0), -1)
                    draw_text_with_outline(frame, status_msg, (20, 75), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
                else:
                    # Normal Operation
                    ...
                    if hand_detected:
                        ...
                        draw_text_with_outline(frame, state, (w-200, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 3)

                # Persistent Keyboard Shortcuts HUD
                draw_text_with_outline(frame, "Shortcuts: [Q] Quit | [C] Calibrate | [SPACE] Next", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
